...
public class DateFormatLibrary
{
     private HttpContext cur;
        ...
        public DateFormatLibrary()
        {
            ...
            arCul.DateTimeFormat.Calendar = umAlQuraCalendar;
    ...
    /// negative d1 is smaller than d2, 0 both are equal</returns>
        ...
        /// <summary>
        /// Get two instaces of string date 
        /// and return Days Difference of thier values 
        /// </summary>
        /// <PARAM name="d1"></PARAM>
        /// <PARAM name="d2"></PARAM>
        public int DaysDiffernce(string d1, string d2)
        {
            try
            {
                DateTime date1 = DateTime.ParseExact(d1, allFormats,
        ...
        public DateTime GetDateTime(string Value, string format)
        {
            try
            {
                ...
                DateTime tempDate = DateTime.ParseExact(Value, format,
                    enCul.DateTimeFormat, DateTimeStyles.AllowWhiteSpaces);
                return tempDate;
