<%@ Page Title="" Language="C#" MasterPageFile="~/HMS.Master" AutoEventWireup="true" CodeFile="designation.aspx.cs" Inherits="HMS.designation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>Manage Designation
                            </h2>
                </div>
                <div class="body">
                    <div class="form-group form-float">
                        <div class="form-line">
                            <asp:DropDownList ID="ddlDepartment" runat="server" CssClass="form-control show-tick" DataValueField="idx" DataTextField="departmentName" data-live-search="true" required>
                            </asp:DropDownList>
                        </div>
                    </div>
                    <div class="form-group form-float">
